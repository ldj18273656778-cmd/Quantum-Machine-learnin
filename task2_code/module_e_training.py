...
from task2_code.ansatz import ansatz_scope_size
from task2_code.ansatz_registry import ansatz_theta_count, random_ansatz_theta
from task2_code.lightcone import (
...
from task2_code.loss_registry import get_active_loss_function, residual_operator_for_context as _registry_residual_operator_for_context
...
def multi_restart_train(
    ...
    *,
    ...
    for restart_idx in range(restarts):
        ...
        result = adam_optimize(loss_fn, theta0, config, show_progress=show_progress, step_callback=step_callback)
