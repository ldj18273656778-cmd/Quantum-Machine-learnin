...
from task2_code_auto.module_e_training import build_target_objective_context, residual_operator_for_context
from task2_code_auto.sewing.block_sewing import load_block_specs
from task2_code_auto.superoperator_registry import resolve_superop
