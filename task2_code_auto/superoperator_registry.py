...
Usage:
    from task2_code_auto.superoperator_registry import set_active_superop, get_active_superop
...
from task2_code_auto.superoperator import per_bit_losses_from_V, per_bit_losses_from_V_one_env, per_bit_losses_from_V_zero_env
